...
SSD <- function(m=1000, t.points=c(1,2,3,4,5), var.u0=0, var.u1=.1, var.e=.02, eff.size=.8, BFthres=3, eta=.8){
  ...
  medBF.H0 <- vector("list", 300)
  medBF.H1 <- vector("list", 300)
  medBFc.H0 <- vector("list", 300)
  medBFc.H1 <- vector("list", 300)
  medBFu.H0 <- vector("list", 300)
  medBFu.H1 <- vector("list", 300)
  prop.BF.H0 <- vector("list", 300)
  prop.BF.H1 <- vector("list", 300)
  PMP.c0 <- vector("list", 300)
  PMP.c1 <- vector("list", 300)
...
colors <- c("Large Effect" = "red", "Medium Effect" = "blue", "Small Effect" = "orange")

...
SSD <- function(m=100, t.points=c(1,2,3,4,5), var.u0=0, var.u1=.1, var.e=.0262, eff.size=.8, BFthres=3, eta=.8){
  ...
  measures <- cbind(medBF01.H0,medBF10.H1, prop.BF01.H0, prop.BF10.H1)

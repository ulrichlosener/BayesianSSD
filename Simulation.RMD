...
for(j in 1:10){
  ...
  beta2 <- rep(.4, N*n) # average difference in slopes between conditions
...
par(mfrow=c(2,2))
plot(x=seq(10,100,10), y=mbf12, type="l", xlab="N", ylab="mean BF12", ylim=c(0,1000))
...
par(mfrow=c(2,2))
plot(x=seq(10,100,10), y=medbf12, type="l", xlab="N", ylab="median BF12")
plot(x=seq(10,100,10), y=medbf21, type="l", xlab="N", ylab="median BF21")
plot(x=seq(10,100,10), y=medbf.u, type="l", xlab="N", ylab="median BF unconstr.")
plot(x=seq(10,100,10), y=medbf.c, type="l", xlab="N", ylab="median BF complement")

par(mfrow=c(1,2))
plot(x=seq(10,100,10), y=quantbf12, type="l", xlab="N")
plot(x=seq(10,100,10), y=prop.bf12, type="l", xlab="N")

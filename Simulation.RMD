...
bayesian.SSD <- function(n.steps = 20, m = 100, eff.size = .8, BFthresh = 3, t.points = c(0,1,2,3,4)) {
  ...
  BFthresh <- 3  # desired Bayes Factor 
  ...
  for(j in 1:n.steps){
    ...
    if (max(prop.bf01.H0)>.8 & max(prop.bf10.H1)>.8) {break}
  }
